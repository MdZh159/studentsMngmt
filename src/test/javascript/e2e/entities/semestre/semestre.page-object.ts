...
export class SemestreComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-semestre div table .btn-danger'));
  title = element.all(by.css('jhi-semestre div h2#page-heading span')).first();
...
export class SemestreUpdatePage {
  pageTitle = element(by.id('jhi-semestre-heading'));
...
export class SemestreDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-semestre-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-semestre'));
